...
BOT_TOKEN = getenv("BOT_TOKEN", "7732000256:AAEhvG8504KcDrD0FZ44AEoiTEhEJjXuQfg")
...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/Devensh22345/Extra-Plugin",
)
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6872968794").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Devensh22345/alya_music",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/zoya_update"
)  # Example:- https://t.me/akaChampu
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/zoya_update"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/Devensh22345/alya_music")
...
TG_VIDEO_FILESIZE_LIMIT = int(getenv("TG_VIDEO_FILESIZE_LIMIT", "4000000000")) # Remember to give value in bytes
